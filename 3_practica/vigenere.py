...
vigenere = Vigenere("ABCDEFGHIJKLMNÑOPQRSTUVWXYZ","EQNJAJI")

# Se abre el archivo donde se encuentra el texto cifrado
cifrado = open("One.txt","r")
# Archivo en el que se va a guardar el texto descifrado
descifrado = open("descifrado.txt","w")

# Se lee cada linea, se descifra y se guarda en el archivo.
for linea in cifrado:
	descifrado.write(vigenere.decipher(linea.rstrip('\n')) + "\n")
