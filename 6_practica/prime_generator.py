...
def is_prime(n):
	"""
	Implementación del test de primalidad basado en la paradoja del cumpleaños.
	:param n: el número a determinar si es primo.
	:return: True si n es posiblemente primo, False en otro caso.
	"""
